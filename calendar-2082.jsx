              ...
              >
                ...
                >
                  {showTimeAware && timeAware
                    ...
                    : <><span className="count-tick" style={{ display: "inline-block", minWidth: "18px", textAlign: "right" }}>{displayWorkingDaysBS}</span>{" "}{excludeWeekends || customWorkingDays != null ? "working days" : "days"}{heartActive ? " left" : ""}</>
                  }
                </span>
              </span>
              <button
